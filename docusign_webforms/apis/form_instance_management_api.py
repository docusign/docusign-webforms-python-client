...
class FormInstanceManagementApi(object):
    ...
    def create_instance(self, account_id, form_id, create_instance_body, **kwargs):
        ...
        :param str form_id: Unique identifier for a webform entity that is consistent for it's lifetime (required)
        :param CreateInstanceRequestBody create_instance_body: (required)
    ...
    def get_instance(self, account_id, form_id, instance_id, **kwargs):
        ...
        :param str account_id: Account identifier in which the webform resides (required)
        :param str form_id: Unique identifier for a webform entity that is consistent for it's lifetime (required)
        :param str instance_id: Unique identifier for a webform instance that is consistent until its expiration (required)
        :return: WebFormInstance
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def list_instances_with_http_info(self, account_id, form_id, **kwargs):
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[WebFormInstance]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def update_instance(self, account_id, form_id, instance_id, update_instance_body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_instance(account_id, form_id, instance_id, update_instance_body, callback=callback_function)
        ...
        :param str form_id: Unique identifier for a webform entity that is consistent for it's lifetime (required)
        :param str instance_id: Unique identifier for a webform instance that is consistent until its expiration (required)
        :param UpdateInstanceRequestBody update_instance_body: (required)
        :return: WebFormInstance
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_instance_with_http_info(account_id, form_id, instance_id, update_instance_body, **kwargs)
        else:
            (data) = self.update_instance_with_http_info(account_id, form_id, instance_id, update_instance_body, **kwargs)
            return data

    def update_instance_with_http_info(self, account_id, form_id, instance_id, update_instance_body, **kwargs):
        """
        Update form instance
        Preferred endpoint to update form instance properties, including clearing out formValues
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_instance_with_http_info(account_id, form_id, instance_id, update_instance_body, callback=callback_function)
        ...
        all_params = ['account_id', 'form_id', 'instance_id', 'update_instance_body']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'account_id' is set
        if ('account_id' not in params) or (params['account_id'] is None):
            raise ValueError("Missing the required parameter `account_id` when calling `update_instance`")
        # verify the required parameter 'form_id' is set
        if ('form_id' not in params) or (params['form_id'] is None):
            raise ValueError("Missing the required parameter `form_id` when calling `update_instance`")
        # verify the required parameter 'instance_id' is set
        if ('instance_id' not in params) or (params['instance_id'] is None):
            raise ValueError("Missing the required parameter `instance_id` when calling `update_instance`")
        # verify the required parameter 'update_instance_body' is set
        if ('update_instance_body' not in params) or (params['update_instance_body'] is None):
            raise ValueError("Missing the required parameter `update_instance_body` when calling `update_instance`")
        ...
        body_params = None
        if 'update_instance_body' in params:
            body_params = params['update_instance_body']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.\
            select_header_accept(['application/json'])
