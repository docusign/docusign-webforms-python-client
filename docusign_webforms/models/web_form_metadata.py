...
class WebFormMetadata(object):
    ...
    swagger_types = {
        ...
        'published_slug': 'str',
        'published_component_names': 'WebFormPublishedNames',
        'adm_model_namespace': 'str',
        'adm_model_version': 'str'
    }
    ...
    def __init__(self, _configuration=None, **kwargs):  # noqa: E501
        ...
        self._adm_model_namespace = None
        self._adm_model_version = None
        ...
        setattr(self, "_{}".format('adm_model_namespace'), kwargs.get('adm_model_namespace', None))
        setattr(self, "_{}".format('adm_model_version'), kwargs.get('adm_model_version', None))
    ...
    def published_component_names(self):
        ...
        Dictionary containing mapping of componentName to ADM type for all the published components  # noqa: E501

        :return: The published_component_names of this WebFormMetadata.  # noqa: E501
        :rtype: WebFormPublishedNames
        """
    ...
    def published_component_names(self, published_component_names):
        ...
        :type: WebFormPublishedNames
        """

        self._published_component_names = published_component_names

    @property
    def adm_model_namespace(self):
        """Gets the adm_model_namespace of this WebFormMetadata.  # noqa: E501

        The ADM Model namespace of a published WebForm. The namespace does not include version  # noqa: E501

        :return: The adm_model_namespace of this WebFormMetadata.  # noqa: E501
        :rtype: str
        """
        return self._adm_model_namespace

    @adm_model_namespace.setter
    def adm_model_namespace(self, adm_model_namespace):
        """Sets the adm_model_namespace of this WebFormMetadata.

        The ADM Model namespace of a published WebForm. The namespace does not include version  # noqa: E501

        :param adm_model_namespace: The adm_model_namespace of this WebFormMetadata.  # noqa: E501
        :type: str
        """

        self._adm_model_namespace = adm_model_namespace

    @property
    def adm_model_version(self):
        """Gets the adm_model_version of this WebFormMetadata.  # noqa: E501

        The ADM Model version of a published WebForm. We only bump up minor version when publish a form.  # noqa: E501

        :return: The adm_model_version of this WebFormMetadata.  # noqa: E501
        :rtype: str
        """
        return self._adm_model_version

    @adm_model_version.setter
    def adm_model_version(self, adm_model_version):
        """Sets the adm_model_version of this WebFormMetadata.

        The ADM Model version of a published WebForm. We only bump up minor version when publish a form.  # noqa: E501

        :param adm_model_version: The adm_model_version of this WebFormMetadata.  # noqa: E501
        :type: str
        """

        self._adm_model_version = adm_model_version
